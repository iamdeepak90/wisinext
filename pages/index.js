...
export default function Home() {
  return (
    <>
      ...
      <div className="expt_section">
          ...
          <div className="expt_col">
          <div className="expt_img"><WebPimg src="images/Web-Solutions-icon.png" alt="Web Solutions" /></div>
          ...
          <div className="expt_col">
          <div className="expt_img"><WebPimg src="images/Graphic-Design-icon.png" alt="Graphic Design" /></div>
          ...
          <div className="expt_col">
          <div className="expt_img"><WebPimg src="images/Mobile-Apps-icon.png" alt="Mobile Apps" /></div>
      ...
      <div className="whyus_abt_section">
          ...
          <div className="whyus_abt_row">
              <WebPimg src="images/year-icon.png" alt="" />
          ...
          <div className="whyus_abt_col">
          <div className="whyus_abt_row">
              <WebPimg src="images/solution-icon.png" alt="" />
          ...
          <div className="whyus_abt_col">
          <div className="whyus_abt_row">
              <WebPimg src="images/client-icon.png" alt="" />
          ...
          <div className="whyus_abt_col">
          <div className="whyus_abt_row">
              <WebPimg src="images/worldwide-icon.png" alt="" />
      ...
      <div className="whyus_client">
          ...
          <div className="whyus_clnt_row">
              <WebPimg src="images/guarantee-icon.png" />
          ...
          <div className="whyus_clnt_col">
          <div className="whyus_clnt_row">
              <WebPimg src="images/meeting-icon.png" />
          ...
          <div className="whyus_clnt_col">
          <div className="whyus_clnt_row">
              <WebPimg src="images/confid-icon.png" />
          ...
          <div className="whyus_clnt_col">
          <div className="whyus_clnt_row">
              <WebPimg src="images/presence-icon.png" />
      ...
      <div className="outer_wrapper">
          ...
          <div className="work_proc_wrap">
              ...
              <div className="work_proc_row">
                  <WebPimg src="images/goals-icon.png" alt="" />
              ...
              <div className="work_proc_col">
              <div className="work_proc_row">
                  <WebPimg src="images/improvment-icon.png" alt="" />
              ...
              <div className="work_proc_col">
              <div className="work_proc_row">
                  <WebPimg src="images/mark-need-icon.png" alt="" />
              ...
              <div className="work_proc_col">
              <div className="work_proc_row">
                  <WebPimg src="images/appr-solution-icon.png" alt="" />
              ...
              <div className="work_proc_col">
              <div className="work_proc_row">
                  <WebPimg src="images/roadmap-icon.png" alt="" />
              ...
              <div className="work_proc_col">
              <div className="work_proc_row">
                  <WebPimg src="images/success-icon.png" alt="" />
  ...
  <div className="our_client_section">
      <div className="outer_wrapper">
          ...
          <WebPimg src="images/client-logo-1.png" alt="" />
          <WebPimg src="images/client-logo-2.png" alt="" />
          <WebPimg src="images/client-logo-3.png" alt="" />
          <WebPimg src="images/client-logo-4.png" alt="" />
          <WebPimg src="images/client-logo-5.png" alt="" />
          <WebPimg src="images/client-logo-6.png" alt="" />
          <WebPimg src="images/client-logo-7.png" alt="" />
          <WebPimg src="images/client-logo-8.png" alt="" />
          </div>{/* ourclnt_row */}
      </div>{/* outer_wrapper */}
      ...
      <div className="let_tlk_wrap">
          ...
          <WebPimg src="images/partho-mandal.png" websrc="images/webp/partho-mandal.webp" alt="" />
          </div>{/* letlk_lft */}
      ...
      <div className="award_section">
          ...
          <div className="award_img"><WebPimg src="images/award-1.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-2.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-3.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-4.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-5.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-6.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-7.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-8.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-9.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-10.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-11.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-12.png" alt="" /></div>				
          <div className="award_img"><WebPimg src="images/award-14.png" alt="" /></div>
          <div className="award_img"><WebPimg src="images/award-13.png" alt="" /></div>
          </div>{/* award_row */}
      </div>{/* award_section */}
      <div className="google_ads_section">
          ...
          <div className="google_ads_col">
              <WebPimg src="images/google-ads-1.png" alt="" />
              <div className="google_ads_txt">Google<br />
              Ads Video<br />
              Certification</div>
          </div>{/* google_ads_col */}
          <div className="google_ads_col">
              <WebPimg src="images/google-ads-2.png" alt="" />
              <div className="google_ads_txt">Google<br />
              Campaign Manager<br />
              Certification</div>
          </div>{/* google_ads_col */}
          <div className="google_ads_col">
              <WebPimg src="images/google-ads-3.png" alt="" />
              <div className="google_ads_txt">Google<br />
              Ads Search<br />
              Certification</div>
          </div>{/* google_ads_col */}
          <div className="google_ads_col">
              <WebPimg src="images/google-ads-4.png" alt="" />
              <div className="google_ads_txt">Google<br />
              Ads Display<br />
              Certification</div>
          </div>{/* google_ads_col */}
          <div className="google_ads_col">
              <WebPimg src="images/google-ads-5.png" alt="" />
              <div className="google_ads_txt">Google<br />
              Shopping Ads<br />
              Certification</div>
          </div>{/* google_ads_col */}
